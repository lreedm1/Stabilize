...
const VERSION = "20260809-mobile-video-v11-1";
...
test("all public Stabilize pages share the chat background and reading colors", async () => {
  ...
  for (const asset of [
    ...
    "/scenes/mobile-forest-stream-v11-1536.webp",
    "/scenes/mobile-forest-stream-v11-1536.webp",
  ]) {
  ...
  assert.match(
    guides,
    /@media \(max-width: 980px\) and \(orientation: portrait\)[\s\S]*mobile-forest-stream-v11-1536/,
  );
  assert.match(
    guides,
