...
const POLICY_SCRIPTS = [
  ...
  "scripts/prepare-instant-thinking-policy.mjs",
  ...
  "scripts/finalize-instant-thinking-tests.mjs",
  "scripts/fix-reasoning-refresh-freeze.mjs",
  "scripts/fix-fastest-response-release.mjs",
  "scripts/fix-fastest-response-worker.mjs",
...
const POLICY_TARGETS = [
  ...
  "test/openai-streaming-worker.test.mjs",
