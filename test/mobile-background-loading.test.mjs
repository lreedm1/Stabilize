...
test("mobile clients keep the static image without loading the graphics module chain", async () => {
  ...
  assert.match(
    ...
    /finalize-native-selected-mobile-v24-regressions\.mjs && node scripts\/finalize-mobile-video-handoff-v31\.mjs && node scripts\/finalize-mobile-smooth-v32\.mjs && node scripts\/finalize-mobile-hevc-v34\.mjs && node scripts\/finalize-mobile-hevc-v35\.mjs && node scripts\/embed-favicon-fallback\.mjs$/,
  );
