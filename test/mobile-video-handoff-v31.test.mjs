...
test("mobile video is parser-loaded and first-touch playback remains synchronous", async () => {
  ...
  assert.match(
    ...
    /finalize-mobile-video-handoff-v31\.mjs && node scripts\/finalize-mobile-smooth-v32\.mjs && node scripts\/finalize-mobile-hevc-v34\.mjs && node scripts\/finalize-mobile-hevc-v35\.mjs && node scripts\/embed-favicon-fallback\.mjs$/,
  );
