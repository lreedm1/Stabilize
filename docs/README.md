# Protocol background documents

These files are public-safe working materials related to Stabilize:

- `stabilize-condensed-core.txt` — short operational version of the protocol
- `crisis-read-this-first.txt` — low-load urgent-use card
- `pocket-aphorisms.txt` and `aphorisms-guide-to-life.txt` — short reminders
- `evidence-based-stability-habits.txt` — research-oriented background report and source list
