...
if (!next.includes("do not attach advice, action steps, coping strategies, or suggested options")) {
  throw new Error("Non-presumptive output instruction was not applied");
}

if (next !== source) await writeFile(path, next);
console.log("Applied non-presumptive, consent-before-help model instructions.");
