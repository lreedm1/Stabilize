/* eslint-disable */
// Generated by Wrangler by running `wrangler types --include-runtime=false` (hash: c1374d8a1aba26a59007272643053ee7)
interface __BaseEnv_Env {
	...
	OPENAI_FREE_TOKENS_ONLY: "true";
	OPENAI_FREE_TOKEN_ALLOWANCE: "1000000";
	OPENAI_FREE_TOKEN_DAILY_LIMIT: "900000";
	OPENAI_FREE_TOKEN_ELIGIBILITY_CONFIRMED: "false";
	OPENAI_API_KEY: string;
	GOOGLE_CLIENT_ID: string;
	GOOGLE_CLIENT_SECRET: string;
	AUTH_SECRET: string;
	OPENAI_USAGE_ADMIN_KEY: string;
	...
	OPENAI_TOKEN_BUDGET: DurableObjectNamespace<import("./src/domain-router").OpenAITokenBudget>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/domain-router");
		durableNamespaces: "SessionMemory" | "BillingAccount" | "FeedbackGate" | "FeedbackInbox" | "ImpactAnalytics" | "OpenAITokenBudget";
	}
